...
#     train_df = pd.read_csv(f"../metadata/DF20M-train_metadata_PROD.csv")  # TODO .. > .

#     valid_df = pd.read_csv(f"../metadata/DF20M-public_test_metadata_PROD.csv")  # TODO
    train_df = pd.read_csv("../metadata/DanishFungi2023-train_mini.csv")
    valid_df = pd.read_csv("../metadata/DanishFungi2023-val_mini.csv")
...
#     train_df['class_id'] = le.fit_transform(train_df['scientificName']).astype(np.int64)
    
#     valid_df["class_id"] = le.fit_transform(valid_df['scientificName']).astype(np.int64)
    
#     print(len(valid_df["class_id"].unique()))
...
if __name__ == "__main__":
    train_clf(train_metadata="a", valid_metadata="b", config_path="../config/224_config.yaml")
